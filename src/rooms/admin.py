...
class SalaAdmin(admin.ModelAdmin):
	list_display = ('id', 'nombre', 'ubicacion', 'horario_disp', 'estado',)
	list_filter   = ('nombre', 'ubicacion', 'horario_disp', 'estado',)
	search_fields = ( 'capacidad__cantidad',)
	list_editable = ('nombre', 'ubicacion', 'horario_disp', 'estado',)
